...
export const mockTutors: TutorConfig[] = [
  {
    ...
    classAssignments: [{ classId: 'class-a', assignedById: 'teacher-1' }],
    assignedStudents: [],
    visibility: 'private',
    icon: '📐',
    color: 'blue',
  ...
  },
  {
    ...
    isEnabled: true,
    status: 'published',
    assignedClasses: ['class-b', 'class-a'],
    classAssignments: [
      { classId: 'class-b', assignedById: 'teacher-2' },
      { classId: 'class-a', assignedById: 'teacher-1' },
    ],
    assignedStudents: [],
    visibility: 'internal',
    internalVisibility: 'groups',
    icon: '⚡',
    color: 'yellow',
