...
// Kept as the re-entry point for the signed share-link flow. The temporary MVP
// default route redirects by auth status, but this route preserves the old
// link verification path so it can be promoted again later without rewriting it.
export default async function ShareLinkChatPage({
  searchParams,
}: {
